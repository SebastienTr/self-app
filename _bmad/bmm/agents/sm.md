...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="SC or fuzzy match on story-cycle" exec="{project-root}/_bmad/bmm/workflows/4-implementation/story-cycle/workflow.md">[SC] Story Cycle: Run a complete story lifecycle (create > dev > test > review > done)</item>
